...
public class ExplainStringMethods {
...
//    }
    ...
    public static boolean validateEmailAddress(String emailAddress) {
        ...
        String[] strEndsWith = {"domain.co.in","domain.com","gmail.com","gmail.net","gmail.io"};
        String[] arrOfStr = emailAddress.split("@", 5);
//        System.out.println(arrOfStr[0].length());
//        System.out.println(emailAddress.substring(0, arrOfStr[0].length()).startsWith("super") && emailAddress.endsWith("com"));
//        char[] alphabet = "abcdefghijklmnopqrstuvwxyz".toCharArray();
//        System.out.println(emailAddress.startsWith(String.valueOf(alphabet[i])));
        for (int i=0; i<strEndsWith.length;i++){
//            Boolean opt = Character.isLetter(emailAddress.charAt(0));
            if (emailAddress.substring(0, arrOfStr[0].length()).startsWith("s") || emailAddress.endsWith(strEndsWith[i])) {
                answer = String.valueOf(strList.add(emailAddress));
                System.out.println(answer);
            }
//            else if (emailAddress.substring(0, arrOfStr[0].length()).startsWith("s") && emailAddress.endsWith(strEndsWith[2])) {
